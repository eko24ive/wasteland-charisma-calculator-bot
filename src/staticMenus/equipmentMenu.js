...
🔆 (36⚔️) - Транзистор(15);  Изолента(16);
...
🔆 (37⚔️) - Транзистор(19);  Что-то чугунное(20);
...
🔆 (83⚔️) - Сердце трога(34);  Детская кукла(13);
...
▫️⚙️ Силовая броня(25🛡)
🏅 +45🛡 Минизаряд(7); Провода(5);  
🔆 +51🛡 Минизаряд(17); Провода(15);  

▫️⚙️ Силовая броня🎖(35🛡)
🏅 +65🛡  Провода(7);
🔆 +71🛡  Провода(19);

▫️⚙️ Силовая броня🎖🎖(45🛡)
🏅 +70🛡 Транзистор(8);  Изолента(9);
🔆 +79🛡 Транзистор(18);  Изолента(19);

▫️*⚙️Броня Безумца* (58🛡)
🏅 (75🛡) - Фольга!(2);  Сердце трога(11);  Потенциометр(3);  Сталь(4);
🔆 (84🛡) - Фольга!(12);  Сердце трога(21);  Потенциометр(13);  Сталь(14);
...
🔆 (103🛡) - Фольга!(25);  Изолента(24);  Провода(25);

▫️*⚛️Нановолокно* (89🛡)
🏅 (113🛡) - Фольга!(3);  Вольфрам(13);  Изолента(12);  Провода(16);
🔆 (126🛡) - Фольга!(25);  Вольфрам(23);  Изолента(24);  Провода(38);
