...
▪️Фалмерский клинок (⛰Старая шахта, 11км)
▪️Батарейка BIOS (🚽Сточная труба, 23км)
〰〰〰〰〰〰〰〰〰〰〰〰〰〰
📥 *Модуль реакции* (🤸🏽‍♂️+50)
...
▪️Выпадает в 🔬Научной лаборатории, 56км
〰〰〰〰〰〰〰〰〰〰〰〰〰〰
📥 *Модуль нанополя* (+🛡1.5 за каждый км)
▪️Выдает 👴Безузмный старик на 8км. Шестой предмет по очереди сборки.
〰〰〰〰〰〰〰〰〰〰〰〰〰〰
