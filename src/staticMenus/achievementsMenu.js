...
✅*Ачивки* дают за определенные действия в игре:
...
const chemsText = `
*Ачивки* получаемые за употребление *❤️Веществ*: 
...
const foodText = `
*Ачивки* получаемые за употребление *🍗Еды*: 
