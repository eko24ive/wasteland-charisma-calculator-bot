...
🗃<b>Припасы</b> можно найти в пустоши, получить победив мобов, пройдя квестовые локации и т.д.
 ...
 ▫️🍱<b>Еда</b>: уменьшает процент 🍗Голода 
 ▫️🍹<b>Баффы</b>: дают временный прирост Навыков
`;

const foodText = `
🍱<b>Еда</b> уменьшает процент 🍗Голода. От некоторой еды дополнительно повышается или понижается оставшееся здоровье 
