...
Выбери интересующий диапазон километров, после тебе будет доступен список мобов, которые были замечены на этом километре.
...
<i>Отсортированы от слабых к сильным</i>
${beastsList}
`;
